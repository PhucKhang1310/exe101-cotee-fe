      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-2 gap-16 items-center mb-32">
          <div className="space-y-6">
            <div className="inline-block px-4 py-2 bg-[#fff5eb] rounded-full">
              <span className="text-sm font-bold text-[#ff9429]">AI-POWERED</span>
            </div>
            <h2 className="text-4xl font-bold text-[#0f172a]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-[#ff9429] shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-[#fff5eb] to-white rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
              <img src={imgAiContentImage} alt="AI Design" className="w-full h-full object-cover" />
            </div>
            <div className="absolute -bottom-8 -right-8 w-64 h-64 bg-[#ffa62b] rounded-full opacity-10 blur-3xl" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-8 mb-32">
          {[
            ...
            <div key={i} className="bg-white rounded-2xl p-8 border border-[#f1f5f9] hover:border-[#ffa62b] hover:shadow-xl transition-all group">
              <div className="w-16 h-16 bg-gradient-to-br from-[#fff5eb] to-[#ffe5cc] rounded-2xl flex items-center justify-center mb-6 text-[#ff9429] group-hover:scale-110 transition-transform">
                {feature.icon}
              </div>
